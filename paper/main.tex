...
That same visibility condition can now also resolve a deferred world later in time, so line of sight becomes part of observation-frontier convergence rather than only a static branching cue.
