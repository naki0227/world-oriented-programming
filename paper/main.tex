...
This convergence work is also starting to connect back to geometry, since a pursuit-like candidate can now be preferred only when another entity remains visible, making line of sight part of world evolution rather than only part of contradiction reporting.
