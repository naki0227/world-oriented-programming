...
def fire_world_branch(candidates, visible):
    preferred = "pursue" if visible else "search"
...
def simulate():
    ...
    selected = fire_world_branch(candidate_event(), visibility_event(a, b, wall_min, wall_max))
