...
def enforce_time_varying_gate(sphere, wall, gate, open_time, current_time):
    ...
    if current_time < open_time:
        ...
        return
    if not inside_gate_aperture(sphere, gate):
        clamp_inside_halfspace(wall, sphere, margin)
...
def advance_with_gate_schedule(sphere, wall, gate, open_time, start_time, dt, steps):
    ...
    for _ in range(steps):
        ...
        enforce_time_varying_gate(sphere, wall, gate, open_time, current_time)
