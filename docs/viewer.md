...
- a first path-tube world where a sphere is kept inside a declared trajectory corridor
...
cargo run -p sekai-cli -- simulate-report examples/surface_gate_clear.sk > viewer/samples/surface_gate_clear.json
...
cargo run -p sekai-cli -- simulate-report examples/surface_gate_route_left.sk > viewer/samples/surface_gate_route_left.json
cargo run -p sekai-cli -- simulate-report examples/surface_gate_route_right.sk > viewer/samples/surface_gate_route_right.json
...
cargo run -p sekai-cli -- simulate-report examples/path_tube_clamped.sk > viewer/samples/path_tube_clamped.json
cargo run -p sekai-cli -- simulate-report examples/path_tube_reject.sk > viewer/samples/path_tube_reject.json
